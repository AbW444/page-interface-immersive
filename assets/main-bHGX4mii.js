import{R as T,V,C as F,a as x,S as U,A as q,D as k,F as L,P as G,W,b as Y,H as X,T as I,c as v,M as C,d as y,e as _,B as Z,f as K,L as z,g as J,h as Q,i as B,j as A,k as D,l as O,m as ee,n as te,o as H,p as ie,q as oe}from"./three-mYGB6aLE.js";import{g as c}from"./gsap-D3jsOSc0.js";import{i as se}from"./utils-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const ne={"grande-barriere":"https://page-collection-les-ombres-de-la-mer.vercel.app/",abysses:"https://page-collection-les-ombres-de-la-mer.vercel.app/",arctique:"https://page-collection-les-ombres-de-la-mer.vercel.app/",plastique:"https://page-collection-les-ombres-de-la-mer.vercel.app/","triangle-corail":"https://page-collection-les-ombres-de-la-mer.vercel.app/",requins:"https://page-collection-les-ombres-de-la-mer.vercel.app/"},ae="https://page-collection-les-ombres-de-la-mer.vercel.app/";function re(p){return ne[p]||ae}class le{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.hotspotObjects=[],this.raycaster=new T,this.mouse=new V,this.clock=new F,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.5,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new x(100,20,100),moonPosition:new x(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new U;const e=new q(16777215,1.2);this.scene.add(e);const t=new k(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new L(0,15e-5),this.camera=new G(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition(),this.renderer=new W({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(window.devicePixelRatio),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Y,this.container.appendChild(this.renderer.domElement),this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),this.addLogo()}addLogo(){const e=document.createElement("div");e.style.cssText=`
            position: absolute;
            top: 20px;
            left: 50%;
        ...
        `,e.appendChild(t),this.container.appendChild(e)}setupLighting(){const e=new q(4210768,.5);this.scene.add(e);const t=new k(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const o=new X(35071,65416,.6);this.scene.add(o)}createCelestialBodies(){const e=new I,t=e.load("/public/images/sun-texture.jpg"),o=new v(3,32,32),i=new C({map:t,transparent:!0,opacity:.95}),s=new y(o,i);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/public/images/moon-texture.jpg"),a=new v(1.5,32,32),r=new _({map:n}),l=new y(a,r);l.position.copy(this.celestialParams.moonPosition),this.scene.add(l),this.sun=s,this.moon=l}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,r=this.orbitParams.ellipseMinorAxis,l=this.orbitParams.inclination;let d=a*Math.cos(n),u=r*Math.sin(n);const m=u*Math.sin(l);u=u*Math.cos(l),e.push(new x(d,m,u))}new Z().setFromPoints(e);const o=new v(.2,16,16),i=new C({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new y(o,i),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.options.videoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(d=>{console.error("Impossible de relancer la vidéo:",d)}))},1e3);const t=new K(e);t.minFilter=z,t.magFilter=z,t.format=J,t.colorSpace=Q;const o=new v(1.99,64,64),i=new C({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:B}),s=new y(o,i);s.renderOrder=0,this.scene.add(s),this.depthSphere=s;const n=new v(2,64,64),a=new C({map:t,transparent:!0,opacity:1,side:B,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new y(n,a),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const r=new v(2.02,64,64),l=new C({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new y(r,l),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(d=>{console.error("Erreur lors de la lecture de la vidéo:",d),this.handleVideoError()})}createAtmosphere(){const e=new v(2.08,64,64),t=new A({vertexShader:`
            ...
            `,uniforms:{cameraPosition:{value:new x}},blending:O,side:D,transparent:!0}),o=new y(e,t);this.scene.add(o),this.atmosphere=o,this.updateAtmosphereUniforms=()=>{this.atmosphere&&this.atmosphere.material.uniforms&&this.atmosphere.material.uniforms.cameraPosition.value.copy(this.camera.position)}}createSkybox(){new I().load("/public/images/night-sky.png",o=>{this.renderer.toneMapping=ee,this.renderer.toneMappingExposure=.3;const i=new te(o.image.height);i.fromEquirectangularTexture(this.renderer,o),this.scene.background=i.texture,this.scene.fog=new L(17,8e-5)},void 0,o=>{console.error("Erreur lors du chargement de la texture du ciel:",o),this.scene.background=new H(17)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let o=e*Math.cos(this.orbitParams.orbitAngle),i=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=i*Math.sin(s);i=i*Math.cos(s),this.camera.position.set(o,n,i),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(o,n,i),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new x(o,n,i)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let o=e*Math.cos(this.orbitParams.orbitAngle),i=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=i*Math.sin(s);i=i*Math.cos(s),this.camera.position.set(o,n,i),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{this.scene.remove(t),t.userData.labelContainer&&document.body.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],e.forEach(t=>{const{position:o,title:i}=t,s=o.lat*(Math.PI/180),n=o.lng*(Math.PI/180),a=2.1,r=a*Math.cos(s)*Math.cos(n),l=a*Math.sin(s),d=a*Math.cos(s)*Math.sin(n);console.log(`Hotspot ${i}: GPS(${o.lat}, ${o.lng}) -> 3D(${r.toFixed(2)}, ${l.toFixed(2)}, ${d.toFixed(2)})`);const u=new v(.05,16,16),m=new C({color:16763904,transparent:!0,opacity:.8}),h=new y(u,m);h.position.set(r,l,d),h.userData={hotspot:t};const E=new v(.08,16,16),w=new C({color:16763904,transparent:!0,opacity:.5,side:D}),M=new y(E,w);h.add(M),this.addHotspotLabel(h,i,new x(r,l,d)),this.scene.add(h),this.hotspotObjects.push(h)})}addHotspotLabel(e,t,o){const i=document.createElement("div");i.className="hotspot-label-container",i.style.cssText=`
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        `;const n=document.createElement("div");n.className="connector-line",n.style.cssText=`
            position: absolute;
        ...
        `,i.appendChild(s),i.appendChild(n),document.body.appendChild(i),e.userData.label=s,e.userData.connector=n,e.userData.labelContainer=i,e.userData.worldPosition=o.clone();const a=r=>{const l=new x().copy(r).project(this.camera);if(l.z>1||l.x<-1||l.x>1||l.y<-1||l.y>1)return!1;const d=new x().subVectors(r,this.camera.position).normalize(),m=new T(this.camera.position,d).intersectObject(this.globe);if(m.length>0){const h=m[0].distance,E=this.camera.position.distanceTo(r);return h>E-.1}return!0};e.onBeforeRender=()=>{if(!e.userData.label||!e.userData.connector)return;if(a(e.userData.worldPosition)&&!this.orbitParams.inHotspotMode){const l=e.userData.worldPosition.clone();l.project(this.camera);const d=(l.x*.5+.5)*window.innerWidth,u=(-l.y*.5+.5)*window.innerHeight,m=window.innerWidth/2,h=window.innerHeight/2,E=Math.sqrt(Math.pow(d-m,2)+Math.pow(u-h,2)),w=Math.atan2(u-h,d-m),M=Math.min(m,h)*.6;let f,b;if(E<M){const S=M+60+Math.sin(w*5)*20;f=m+Math.cos(w)*S,b=h+Math.sin(w)*S;const g=20;f<g&&(f=g),f>window.innerWidth-g&&(f=window.innerWidth-g),b<g&&(b=g),b>window.innerHeight-g&&(b=window.innerHeight-g)}else{const S=t.length*8,g=25+S*.25,P=10;d+g+S>window.innerWidth-20?f=d-g-S:f=d+g,u-P-30<20?b=u+P:b=u-P}e.userData.label.style.left=`${f}px`,e.userData.label.style.top=`${b}px`,e.userData.label.style.opacity="1",n.style.left=`${d}px`,n.style.top=`${u}px`;const R=Math.sqrt(Math.pow(f-d,2)+Math.pow(b-u,2)),j=Math.atan2(b-u,f-d);n.style.width=`${R}px`,n.style.transform=`rotate(${j}rad)`,n.style.opacity="1",n.style.animation="pulseConnector 2s infinite alternate"}else e.userData.label.style.opacity="0",n.style.opacity="0"}}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const i=t[0].point,n=Math.acos(i.y/2),a=Math.atan2(i.z,i.x),r=90-n*180/Math.PI,l=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${r.toFixed(2)}, lng: ${l.toFixed(2)}`);const d=this._findNearestHotspot(r,l,10);if(d){console.log(`Hotspot trouvé: ${d.title}`),this.activateHotspot(d);return}}const o=this.raycaster.intersectObjects(this.hotspotObjects);if(o.length>0){const i=o[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${i.title}`),this.activateHotspot(i)}}_findNearestHotspot(e,t,o){let i=null,s=o;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const r=a.position.lat,l=a.position.lng,d=Math.sqrt(Math.pow(r-e,2)+Math.pow(l-t,2));d<s&&(s=d,i=a)}return i}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),o=e.position.lng*(Math.PI/180),i=2.1,s=i*Math.cos(t)*Math.cos(o),n=i*Math.sin(t),a=i*Math.cos(t)*Math.sin(o),r=new x(s,n,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=r.clone().normalize().multiplyScalar(3.5);c.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),c.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
           ...
           z-index: 9999;
           pointer-events: none;
       `,document.body.appendChild(t),c.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const o=re(e.id);console.log(`Redirection vers: ${o}`),window.location.href=o}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),o=(e.lng+180)*(Math.PI/180),i=-(2.1*Math.sin(t)*Math.cos(o)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(o),a=new ie(0,.3,32),r=new A({uniforms:{color:{value:new H(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `;for(let r=0;r<3;r++){const l=document.createElement("div");l.style.cssText=`
            ...
            `;for(let d=0;d<3+r;d++){const u=document.createElement("div"),m=360/(3+r)*d;u.style.cssText=`
                    position: absolute;
                    width: ${8-r}px;
                    height: ${8-r}px;
                ...
                `,l.appendChild(u)}i.appendChild(l)}const s=document.createElement("div");s.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,i.appendChild(s);const n=document.createElement("div");n.style.cssText=`
            ...
            font-size: 16px;
            letter-spacing: 2px;
        `,n.textContent="INITIALISATION DU SYSTÈME...",o.appendChild(i),o.appendChild(n);const a=document.createElement("style");a.textContent=`
            @keyframes orbit0 {
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const o={...{count:50,container:this.container},...e},i=document.createElement("div");i.className="background-particles",i.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<o.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,r=Math.random()*100,l=Math.random()*100,d=Math.random()*5,u=Math.random()*10+10,m=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(i=>{i.style.cssText=`
        ...
        `,e.appendChild(t),this.mainContainer.appendChild(e)}initSatelliteInterface(){const e=document.getElementById("coord-lat"),t=document.getElementById("coord-lng"),o=document.getElementById("zoom-level"),i=document.getElementById("orbit-status"),s=document.getElementById("altitude-value"),n=document.getElementById("current-date"),a=document.getElementById("current-time");setInterval(()=>{const r=new Date,l={day:"2-digit",month:"2-digit",year:"numeric"};n&&(n.textContent=r.toLocaleDateString("fr-FR",l));const d=String(r.getUTCHours()).padStart(2,"0"),u=String(r.getUTCMinutes()).padStart(2,"0"),m=String(r.getUTCSeconds()).padStart(2,"0");if(a&&(a.textContent=`${d}:${u}:${m}`),this.globeManager&&this.globeManager.camera){const h=this.globeManager.camera.position,E=Math.sqrt(h.x*h.x+h.z*h.z),w=Math.atan2(h.z,h.x)*(180/Math.PI),M=Math.atan2(h.y,E)*(180/Math.PI);e&&(e.textContent=Math.abs(M).toFixed(4)+(M>=0?"":"-")),t&&(t.textContent=Math.abs(w).toFixed(4)+(w>=0?"":"-"));const f=h.length();s&&(s.textContent=f.toFixed(3)),o&&this.globeManager.orbitParams&&(o.textContent=this.globeManager.orbitParams.zoomLevel.toFixed(1)),i&&this.globeManager.orbitParams&&(this.globeManager.orbitParams.inHotspotMode?(i.textContent="FIXÉE",i.style.color="#ffcc00"):this.globeManager.orbitParams.currentSpeed>this.globeManager.orbitParams.baseSpeed*1.5?(i.textContent="ACCÉLÉRÉE",i.style.color="#ff9900"):this.globeManager.orbitParams.currentSpeed<this.globeManager.orbitParams.baseSpeed?(i.textContent="RALENTIE",i.style.color="#66ccff"):(i.textContent="NORMALE",i.style.color="#ffffff"))}},100)}startupSequence(){this.visualEffects.createOrbitalLoaderEffect(()=>{this.finalizeStartup()},4);const e=document.createElement("div");e.style.cssText=`
            max-width: 800px;
            margin: 0 auto;
        `,startupOverlay.appendChild(e),document.body.appendChild(startupOverlay);const t=["Initialisation du système de navigation...","Chargement des modules cartographiques...","Calibration des capteurs océanographiques...","Établissement de la liaison satellite...","Chargement des données bathymétriques...","Analyse des courants marins...","Détection des points d'intérêt...","Optimisation de l'interface scientifique...","Calcul de l'orbite ellipsoïdale...","Système opérationnel. Bienvenue à bord."];let o=0;const i=setInterval(()=>{if(o<t.length){const s=document.createElement("div");s.className="startup-message",s.innerHTML=`<span style="color: #66ccff;">[SYSTÈME]</span> ${t[o]}`,s.style.cssText=`
                    margin-bottom: 6px;
                    background-color: rgba(0, 10, 30, 0.7);
                    padding: 6px 10px;
                    border-radius: 4px;
        ...
        `;t.area&&(o+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(o+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(o+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(o+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),o+="</div>";let i="";e.detailedInfo&&(i=`
            ...
            ${i}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.visualEffects&&this.visualEffects.showNotification("Retour à l'exploration globale","info",3e3),this.currentHotspot=null}}const N=new me;function fe(){N.init()}function ge(){return N}function be(){console.log("Application Mondes Immergés en cours de chargement...");const p=document.createElement("style");p.textContent=`
	...
	`,document.head.appendChild(p);const e=document.getElementById("welcome-screen");e&&(e.style.display="none",e.classList.add("hidden"));const t=document.getElementById("main-container");t&&(t.classList.add("hidden"),t.style.opacity="0");let o=0;const i=8,s=()=>{o++;const a=Math.round(o/i*100),r=document.querySelector(".progress-bar"),l=document.querySelector(".progress-text");r&&(r.style.width=`${a}%`),l&&(l.textContent=`${a}%`),o>=i&&xe()};["Configuration système","Textures globe","Vidéos des zones","Données géographiques","Interfaces utilisateur","Modèles 3D","Données scientifiques","Effets visuels"].forEach((a,r)=>{const l=100+Math.random()*200;setTimeout(()=>{console.log(`Ressource chargée: ${a}`),s()},l*(r+1))}),ye()}function ye(){const p=document.getElementById("main-container");if(p.querySelector(".starry-background"))return;const e=document.createElement("div");e.className="starry-background",p.appendChild(e);for(let t=0;t<100;t++){const o=document.createElement("div");o.className="star";const i=Math.random()*100,s=Math.random()*100,n=Math.random()*2+1,a=Math.random()*.7+.3,r=Math.random()*5+3,l=Math.random()*3;o.style.cssText=`
            position: absolute;
            left: ${i}%;
            top: ${s}%;
            width: ${n}px;
        ...
        `,e.appendChild(o)}if(!document.getElementById("star-animation-style")){const t=document.createElement("style");t.id="star-animation-style",t.textContent=`
            @keyframes starTwinkle {
                0%, 100% { opacity: 0.3; }
                50% { opacity: 1; }
            }
        `,document.head.appendChild(t)}}function xe(){console.log("Démarrage de l'application..."),fe();const p=ge();setTimeout(()=>{p?ve(p):console.error("Impossible de récupérer l'instance de l'application")},300)}function ve(p){const e=document.getElementById("loading-screen");e?(e.style.opacity="0",e.style.transform="scale(1.1)",setTimeout(()=>{e.classList.add("hidden");const t=document.getElementById("main-container");t.classList.remove("hidden"),t.style.opacity="1",p.startupSequence?(p.startupSequence(),setTimeout(()=>{p.startExploration(!0)},5e3)):p.startExploration(!0)},500)):p.startExploration(!0)}function we(){const p=document.getElementById("loading-screen");if(!p||p.querySelector(".progress-container"))return;const e=p.querySelector(".spinner");e&&e.remove(),se.register();const t=document.createElement("l-jelly");t.setAttribute("size","60"),t.setAttribute("speed","0.9"),t.setAttribute("color","#ffcc00"),t.style.cssText=`
        margin-bottom: 30px;
        display: block;
    `;const o=p.querySelector("p");o?p.insertBefore(t,o):p.appendChild(t);const i=document.createElement("div");i.className="progress-container",i.style.cssText=`
        width: 300px;
        height: 4px;
    ...
    `;const s=document.createElement("div");s.className="progress-bar",s.style.cssText=`
        ...
        top: 0;
        left: 0;
    `;const n=document.createElement("div");n.className="progress-text",n.style.cssText=`
        position: absolute;
        top: 15px;
        left: 50%;
        transform: translateX(-50%);
        ...
        color: #ffcc00;
        font-family: 'Roboto Mono', monospace;
    `,n.textContent="0%",i.appendChild(s),i.appendChild(n),p.appendChild(i)}document.addEventListener("DOMContentLoaded",()=>{we(),setTimeout(()=>{be()},100)});function Ee(){const p=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");!p||!e||document.addEventListener("mousemove",t=>{const o=t.clientX,i=t.clientY;p.style.left=`${o}px`,p.style.top=`${i}px`,e.style.left=`${o}px`,e.style.top=`${i}px`})}window.addEventListener("load",function(){Ee()});
